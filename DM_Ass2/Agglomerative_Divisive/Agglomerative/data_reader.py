...
class DataReader:
	...
	def __init__(self):
		...
		# self.dataFolder = Path('data1/')
		# self.dataRead = Path('data1/data1.txt')
		# self.dataWrite = Path('data1/data1.pkl')
		# self.sample = Path('data1/sampledata.txt')		
		self.dataDict = dict()
		self.dataArray = []
		self.rawData = ''
		self.checkFolder()
	...
	def loadData(self):
		...
		print("Total no. of initial clusters {}".format(str(len(self.dataDict))))
